...
#print(wine.tst.imp["data"])


# Using missForest
wine.tst.imp <- missForest(wine.tst.is)
wine.tst.imp$ximp


# Model
library(class)
y_pred = knn(train = wine.tra.is[,-1], test = wine.tst.imp$ximp[,-1], cl = wine.tra.is[, 6], k = 1)
...
# Accuracy
cm = table(wine.tst.imp$ximp[,6], y_pred)
library(caret)
confusionMatrix(wine.tst.imp$ximp[,6], y_pred)
